<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RichTextEditDraggableControl.ascx.cs" Inherits="Report_Control_EditControl_RichTextEditDraggableControl" %>
...
<asp:Panel ID="Panel_Holder" runat="server" CssClass="ReportHolderPanel ReportHolderPanelForSelect">
 ...
 <asp:Label ID="Label_ItemName" runat="server" ></asp:Label>
  ...
  <asp:TextBox ID="TextBox_RichEdit" runat="server" readonly="true" TextMode="MultiLine"></asp:TextBox>
  </div>
