<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TeacherAdmin.aspx.cs" Inherits="Teaching_BackEnd_TeacherAdmin" Title="Untitled Page" %>
    ...
    <div>
        ...
        <br/>博士/硕士届数     <asp:TextBox ID="StudentTerm" runat="server"></asp:TextBox>
            ...
            人</p>
                ...
                <table cellpadding="2px" cellspacing="2px" style="margin-left: 0px; margin-right: auto">
                    <tr>
                        <td align="left">
                            &nbsp;教改论文发表情况</td>
                        <td align="left">
