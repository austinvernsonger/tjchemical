<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyOutTeacher.aspx.cs" Inherits="Engineering_StuBackMag_MyOutTeacher" %>
    ...
    <div  style="font-size: 25px">
     ...
     <div>
         <cc1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="1" Width="100%"
             ...
             <cc1:TabPanel runat="server" HeaderText="我的校外导师" ID="TabPanel1">
                 <ContentTemplate>
                     <asp:Label ID="lblMessage" runat="server" ForeColor="#999999">你还没有提交过校外导师表 :-(</asp:Label><div
                         id="div_list" runat="server">
                         ...
                         <div style="margin-left: 15px; float: left">
                             <asp:LinkButton ID="lbnDownload" runat="server" OnClick="lbnDownload_Click">校导表下载</asp:LinkButton></div>
                         <br />
                         <br />
                         <div id="divmessage" style="display: none">
                             <asp:Label ID="Label1" runat="server" Text="留言：" Font-Bold="True"></asp:Label><br />
                             <asp:TextBox ID="tbMessage" runat="server" Height="100px" TextMode="MultiLine" Width="300px"></asp:TextBox><br />
                             <div style="float: left; width: 260px" id="myNewFile">
                                 <a href="#" onclick="javascript:Browse();">更新校导表</a>
                                 <iframe src="../uploadFile.aspx?id=2&stuid=<%=studentID %>" frameborder="0" id="ifu" name="ifu"
                                     style="display: none"></iframe>
                             </div>
                             <div style="float: left">
                                 <asp:Button ID="btComment" runat="server" Text="回复" BackColor="#3333FF" ForeColor="White"
                                     OnClick="btComment_Click" /></div>
                             <br />
                             <div id="divprocess" style="display: none">
                                 <asp:Image ID="Image1" runat="server" ImageUrl="~/Engineering/Resources/images/Progress.gif" /></div>
                         </div>
                     </div>
                 </ContentTemplate>
             </cc1:TabPanel>
             <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="提交校外导师">
                 <ContentTemplate>
                     <table style="width: 594px">
                         <tr>
                             ...
                             <td align="left" valign="middle" width="394">
                                 <asp:TextBox ID="tbOutTeacher" runat="server" Width="190px"></asp:TextBox>
                             </td>
                         </tr>
                         <tr>
                             ...
                             <td align="left" valign="middle">
                                 <asp:FileUpload ID="fuOutTeacher" runat="server" Width="270px" />
                             </td>
                         </tr>
                     </table>
                     <br />
                     <p>
                         <asp:Button ID="btOutTeacher" runat="server" Height="31px" Text="提交" Width="90px"
                             OnClick="btOutTeacher_Click" BackColor="#3333FF" ForeColor="White" />
                     </p>
                     <div>
                         //文件的大小不能超过2M<br />
                         <cc1:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender1" runat="server" TargetControlID="tbOutTeacher" WatermarkText="我的校外导师信息" WatermarkCssClass="watermarked">
