<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Computer.aspx.cs" Inherits="RepairManagement_Statistics_ComputerRepair" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <asp:Button ID="btnQuery" runat="server" Text="查询" Width="65px" />
        
        <asp:GridView ID="GVCpStatistics" runat="server" AllowPaging="True" 
            PageSize="10" DataSourceID="obj_statistics" BackColor="White" 
            BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" 
            Width="522px" AllowSorting="true" >
        ...
        <asp:ObjectDataSource ID="obj_statistics" runat="server" SelectMethod="GetStatistics" 
