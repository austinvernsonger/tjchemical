<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TimeTableEdit.ascx.cs" Inherits="LabCenter_Reservation_UserControl_TimeTableEdit" %>
...
<div style="width: 100%;">
    <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" CssClass="ajax__tab_xp-theme" ActiveTabIndex="0">
        <ajaxToolkit:TabPanel ID="TabPanel1" runat="server" HeaderText="星期一" Width="10%">
            <ContentTemplate>
                <span><asp:Button ID="MonAdd" runat="server" Text="+" OnClick="MonAdd_Click" />
                 <asp:Button ID="MonDel" runat="server" Text="-" OnClick="MonDel_Click" />
                </span><asp:PlaceHolder ID="MonPlace" runat="server" />
                <%--asp:UpdatePanel ID="MonPanel" UpdateMode="Conditional" ChildrenAsTriggers="false" runat="server">
                    <ContentTemplate>
