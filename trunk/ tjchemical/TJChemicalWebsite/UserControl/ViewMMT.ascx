...
<div id="div_content" runat="server" visible="False">
    <iframe width="100%" scrolling="no" frameborder="0" id="frame_content" 
        onload="javascript:this.height=0;" src='<%
            Response.Write(string.Format("{0}{1}", ConstValue.PureURL, myMMT.GetContentFile()));
         %>'></iframe>
