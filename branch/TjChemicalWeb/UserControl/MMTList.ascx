...
<div style="display: none; visibility: hidden;">
    ...
    <asp:Label ID="lb_Report" runat="server" Text=""></asp:Label>
...
<asp:ObjectDataSource ID="objDS_All" runat="server" SelectMethod="GetList" 
    ...
    <SelectParameters>
        ...
        <asp:ControlParameter ControlID="lb_Report" Name="Report" 
            ...
            <ItemTemplate>
                ...
                <div id="main_line" style="width: 100%;" runat="server" class='<%#ItemCssClass%>'>
                    <div id="main_ctnt" style="float:left; text-align:left;" runat="server">
                        ...
                        <asp:LinkButton ID="lbtn_delete" Text="彻底删除" runat="server" Visible='<%#(Management)&&(DeleteC)%>'
