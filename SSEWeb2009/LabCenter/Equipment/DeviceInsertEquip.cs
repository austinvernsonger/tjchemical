...
{
    public class DeviceInsertEquip
    {
        ...
        string strAdmin;
        string strRemark;
        public DeviceInsertEquip(string strDeviceId, string strDeviceName, string strModel, string strFormat, string strAccount,
        ...
        public Boolean InsertEquip()
        {
            OpEquipmentExecute i = new OpEquipmentExecute(m_DbName,
                new SqlInsertEquip(strDeviceId, strDeviceName, strModel,strFormat,strAccount,strPrice,strDate,strFactory,strStatus,strLocation,strLocation2,strUser, strAdmin, strRemark));
            if (!i.Do())
            {
