<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MaterialApplyTable.aspx.cs" Inherits="LabCenter_Equipment_MaterialApplyTable" %>
...
<body>
    ...
    <div>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="耗材名称">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox2" runat="server"  Text='<%# Bind("MaterialName") %>'></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label2" runat="server" Text='<%# Bind("MaterialName") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="数量">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox4" runat="server"   Text='<%# Bind("Account") %>'></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
        ...
        <fields>
            ...
            <asp:TemplateField HeaderText="耗材名称">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox2" runat="server"  ReadOnly="true" Text='<%# Bind("MaterialName") %>'></asp:TextBox>
                </EditItemTemplate>
                <InsertItemTemplate>
                    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("MaterialName") %>'></asp:TextBox>
                </InsertItemTemplate>
            ...
            <asp:TemplateField HeaderText="数量">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox4" runat="server" ReadOnly="true" Text='<%# Bind("Account") %>'></asp:TextBox>
                </EditItemTemplate>
                <InsertItemTemplate>
                    <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("Account") %>'></asp:TextBox>
                </InsertItemTemplate>
