<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewPaperJudgeDetails.aspx.cs" Inherits="Engineering_TeacherBackMag_ViewPaperJudgeDetails" %>
    ...
    <div style="margin:14px 0 0 16px">
        ...
        <div>
            <asp:DetailsView ID="dvPaperJudgeDetails" runat="server" Height="50px" 
                ...
                CellPadding="5" BorderColor="#666666" BorderStyle="Solid" BorderWidth="1px">
                <Fields>
