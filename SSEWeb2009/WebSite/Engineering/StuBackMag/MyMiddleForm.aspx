<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyMiddleForm.aspx.cs" Inherits="Engineering_StuBackMag_MyMiddleForm" %>
...
<body>
    ...
    <div>
        <cc1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="1" Width="100%"
            ...
            <cc1:TabPanel runat="server" HeaderText="我的中期考核" ID="TabPanel1">
                <ContentTemplate>
                    <asp:Label ID="lblMessage" runat="server" ForeColor="#999999">你还没有提交过中期考核表 :-(</asp:Label>
                    <div id="div_list" runat="server">
                        ...
                        <div style="margin-left: 15px; float: left">
                            <asp:LinkButton ID="lbnDownload" runat="server" OnClick="lbnDownload_Click">考核表下载</asp:LinkButton>
                        </div>
                        <br />
                        <br />
                        <div id="divmessage" style="display: none">
                            ...
                            <div style="float: left; width: 260px" id="myNewFile">
                                <a href="#" onclick="javascript:Browse();">更新考核表</a>
                                <iframe src="../uploadFile.aspx?id=3&stuid=<%=studentID %>" frameborder="0" id="ifu" name="ifu"
            ...
            <cc1:TabPanel runat="server" HeaderText="提交中期考核" ID="TabPanel2">
                <ContentTemplate>
                    <table style="width: 594px">
                        <tr>
                            ...
                            <td align="left" valign="middle" width="394">
                                <asp:TextBox ID="tbSubject" runat="server" Width="190px" Font-Italic="False">我的中期考核表</asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="left" valign="middle">
                                <asp:FileUpload ID="fileuploadMidForm" runat="server" Width="270px" />
                            </td>
                        </tr>
                    </table>
                    <br />
                    <p>
                        <asp:Button ID="btMidForm" runat="server" Height="31px" OnClick="btMidForm_Click"
                            Text="提交" Width="90px" BackColor="#3333FF" ForeColor="White" />
                    </p>
                    <div>
                        //中期考核表的大小不能超过2M
                        <cc1:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender1" runat="server" Enabled="True"
                            TargetControlID="tbSubject" WatermarkText="我的中期考核表" WatermarkCssClass="watermarked">
